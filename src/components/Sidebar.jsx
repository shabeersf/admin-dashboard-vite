...
import { ArrowTopRightOnSquareIcon, ArrowUpIcon, BellIcon, ChartBarIcon, CreditCardIcon, DocumentMagnifyingGlassIcon, EnvelopeIcon, HomeIcon } from '@heroicons/react/20/solid'
const Sidebar = () => {
    return (
        <div className=' bg-slate-800 flex-none w-14 sm:w-20 h-screen'>
            ...
            <div className=' fixed  left-3 sm:left-6 top-[100px]'>
                ...
                <DocumentMagnifyingGlassIcon width={40} className=' bg-gray-600 p-2 rounded-lg mb-4 text-gray-300' />
                <EnvelopeIcon width={40} className=' bg-gray-600 p-2 rounded-lg mb-4 text-gray-300' />
            ...
            <div className='fixed bottom-4 left-3 sm:left-6'>
                ...
                <ArrowTopRightOnSquareIcon width={40} className=' bg-gray-600 p-2 rounded-lg mb-4 text-gray-300' />
            </div>
        </div>
    )
}
